...
export default function App({ Component, pageProps, router }: AppProps): JSX.Element {
  ...
  return <>
  <Head>
    <title>Максим Якушенков | Full Stack Web-Developer | Заказать разработчку сайта онлайн</title>
    ...
    <meta name='keywords' content='веб-разработчик, сайты под ключ, заказать сайт, фрилансер, web-developer, resume, cv, web, react, next, резюме, поиск работы' />
